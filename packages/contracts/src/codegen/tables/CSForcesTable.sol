...
ResourceId constant CSForcesTableTableId = _tableId;

FieldLayout constant _fieldLayout = FieldLayout.wrap(
  0x0061040120202001000000000000000000000000000000000000000000000000
);
...
library CSForcesTable {
  ...
  function decodeStatic(
    ...
    motionId = (Bytes.slice32(_blob, 0));

    potentialId = (Bytes.slice32(_blob, 32));

    power = (uint256(Bytes.slice32(_blob, 64)));

    direction = ForceDirection(uint8(Bytes.slice1(_blob, 96)));
  }
